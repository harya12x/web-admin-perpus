                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>user/edit_data_anggota/<?= $a['kd_anggota']; ?>" class="badge badge-primary">Edit</a>
                                                <a href="<?= base_url() ?>user/hapus_data_anggota/<?= $a['kd_anggota']; ?>" class="badge badge-danger">Delete</a>
                                            </td>
                                        </tr>
                                        </thead>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?= form_open_multipart('user/proses_tambah_data_anggota'); ?>
