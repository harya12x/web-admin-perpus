            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="post" action="<?= base_url('user/proses_edit_data_penerbit') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nama" required="" value="<?= $penerbit['nama'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <button href="<?= base_url('') ?>" class="btn btn-danger">Cancel</button>
                                </div>
                            </div>
                    </div>
