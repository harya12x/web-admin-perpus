            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="post" action="<?= base_url('user/proses_edit_data_pengarang') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nama" required="" value="<?= $pengarang['nama'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <button href="<?= base_url('user/pengarang') ?>" class="btn btn-danger">Cancel</button>
                                </div>
                            </div>
                    </div>
