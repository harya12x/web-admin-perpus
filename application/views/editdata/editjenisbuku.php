            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="post" action="<?= base_url('user/proses_edit_data_jenis_buku') ?>">
                            <input type="hidden" name="kd_jenis_buku" value="<?= $jenis_buku['kd_jenis_buku'] ?>">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Jenis Buku</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nama" required="" value="<?= $jenis_buku['nama'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <button href="<?= base_url('user/anggota') ?>" class="btn btn-danger">Cancel</button>
                                </div>
                            </div>
                    </div>
