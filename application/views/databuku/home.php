                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="kd_buku" class=" form-control" required=""></input>
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input type="text" name="judul" class=" form-control" required=""></input>
                                    <div class="form-group">
                                        <label>Kode Jenis Buku</label>
                                        <input type="number" name="kd_jenis_buku" class=" form-control" required=""></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Kode Penerbit</label>
                                        <input type="number" name="kd_penerbit" class=" form-control" required=""></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Kode Pengarang</label>
                                        <input type="number" name="kd_pengarang" class=" form-control" required=""></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Stok</label>
